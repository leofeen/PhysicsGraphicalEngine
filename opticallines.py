...
class RefractionSegment(LineSegment):
    def __init__(self, first_point: Point, second_point: Point, left_refraction_coefficient: float, right_refraction_coefficient: float):
        super().__init__(first_point, second_point)
